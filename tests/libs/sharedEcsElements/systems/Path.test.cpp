...
#define SETUP(DTPValue) rtype::ecs::Registry registry(std::make_unique<TestDeltaTimeProvider>((DTPValue))); \
    ...
    registry.addSystem<rtype::component::Transform, rtype::component::Velocity, rtype::component::Path>(rtype::system::Path()); \
    registry.addSystem<rtype::component::Transform, rtype::component::Velocity>(rtype::system::VelocityApplicator()); \
...
TEST(PathSystem, useMultipleDotsWorld)
{
    ...
    ASSERT_EQ(registry.getComponents<rtype::component::Transform>()[entity].value().position.x, 2);
    ASSERT_EQ(registry.getComponents<rtype::component::Transform>()[entity].value().position.y, 2);
    ASSERT_EQ(registry.getComponents<rtype::component::Path>()[entity].value().listOfPoints.size(), 0);
}
...
TEST(PathSystem, casualUseEntityBrutalEnd)
{
    ...
    registry.addComponent<rtype::component::Transform>(entity, rtype::component::Transform(rtype::utils::Vector<float>(1, 1)));
    registry.addComponent<rtype::component::Velocity>(entity, rtype::component::Velocity());
