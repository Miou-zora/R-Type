...
TEST(Zipper, init)
{
    ...
    sa3.insertAt(3, 14);
    sa3.insertAt(4, 15);
    ecs::containers::Zipper<ecs::SparseArray<int>, ecs::SparseArray<int>, ecs::SparseArray<int>> iz(sa, sa2, sa3);
...
TEST(Zipper, forEach)
{
    ...
    sa3.insertAt(4, 15);
    int i = 0;
    for (auto &&[value1, value2, value3]: ecs::containers::Zipper(sa, sa2, sa3))
    {
