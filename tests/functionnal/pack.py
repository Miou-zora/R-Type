...
class Server(Packer):
    FORMATS: Dict[int, str] = {
        ...
        0x0010: _HEADER_FOOTER_FORMAT.format(data='HHH'),
        0x0011: _HEADER_FOOTER_FORMAT.format(data='H?'),
        0x0012: _HEADER_FOOTER_FORMAT.format(data='HHH'),
        0x0013: _HEADER_FOOTER_FORMAT.format(data='Hh'),
        0x0020: _HEADER_FOOTER_FORMAT.format(data='HHH'),
        0x0021: _HEADER_FOOTER_FORMAT.format(data='H'),
        0x0022: _HEADER_FOOTER_FORMAT.format(data='HHH'),
        0x0030: _HEADER_FOOTER_FORMAT.format(data='Hiiii'),
        0x0031: _HEADER_FOOTER_FORMAT.format(data='Hii'),
